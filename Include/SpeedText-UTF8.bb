...
Function Text(x,y,txt$,cx=TEXT_LEFT,cy=TEXT_TOP,encoding%=TEXT_UTF8)
...
Function StringWidth(txt$,encoding%=TEXT_UTF8)
    Return TextStringWidth%(txt$, encoding%)
End Function

Function StringHeight(txt$,encoding%=TEXT_UTF8)
